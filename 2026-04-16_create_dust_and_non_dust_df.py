...
def main():
    ...
    wldas_total = option_to_rerun_cached_moisture(wldas_path, processed_wldas_path, dust_df, rerun_moisture_data=False)
    ...
    non_dust_df = add_wldas_moisture_to_dust_df(wldas_total, non_dust_df)

    print(dust_df)
    print(non_dust_df)

    dust_df.to_csv("data/processed/dust_and_non_dust/dust.csv", index=False)
    non_dust_df.to_csv("data/processed/dust_and_non_dust/non_dust.csv", index=False)
...
def option_to_rerun_cached_moisture(wldas_path, processed_wldas_path, dust_df, rerun_moisture_data):
    '''
    :param processed_wldas_path: Path("data/processed/wldas_sample")
    :param rerun_moisture_data: Boolean
    '''
